    ...
    try {
      ...
      switch (type) {
        case "users":
          ...
          data = [
            ["1001", "أحمد محمد", "العذراء", "كشافة", "ahmed@example.com", "نشط"],
            ["1002", "فاطمة علي", "مار جرجس", "مرشدات", "fatima@example.com", "نشط"],
            ["1003", "محمد حسن", "الأنبا أنطونيوس", "جوالة", "mohamed@example.com", "نشط"],
            ["1004", "مريم يوسف", "العذراء", "أشبال", "mariam@example.com", "نشط"],
            ["1005", "مينا صبحي", "مار جرجس", "براعم", "mina@example.com", "نشط"],
            ["1006", "نادية محمد", "الأنبا أنطونيوس", "ذوو الهمم", "nadia@example.com", "نشط"],
          ]
        ...
        case "results":
          ...
          data = [
            ["1001", "أحمد محمد", "العذراء", "كشافة", "8", "80%", "85", "90", "88", "92", "86.5", "2025-07-15", "مكتمل", "مقفل"],
            ["1002", "فاطمة علي", "مار جرجس", "مرشدات", "7", "70%", "78", "85", "80", "88", "77.5", "2025-07-16", "مكتمل", "مقفل"],
            ["1003", "محمد حسن", "الأنبا أنطونيوس", "جوالة", "9", "90%", "88", "92", "90", "95", "89.8", "2025-07-17", "مكتمل", "مقفل"]
          ]
